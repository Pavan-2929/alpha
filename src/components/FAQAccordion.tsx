        ...
        <>
            <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="w-full">
                    ...
                    {faqs.map((faq, index) => (
                        <Accordion key={index} type="single" collapsible>
                            ...
                            >
                                <AccordionTrigger
                                    className="p-4 flex justify-between items-center text-lg text-gray-700 font-medium rounded-lg cursor-pointer transition-colors duration-300"
                                >
                                    {faq.question}
                                </AccordionTrigger>
                ...
                <div className="flex justify-end items-center">
                    <img src={faq} className="w-full h-auto max-w-[400px] rounded-lg shadow-lg" alt="FAQ illustration" />
                </div>
            </div>
        </>
    );
